    ...
    override fun onCreate(sqLiteDatabase: SQLiteDatabase) {
        try {
            ...
            val consulta = ("CREATE TABLE ${ComunityContract.Companion.Entrada.NOMBRE_TABLA} "
                    ...
                    + " , ${ComunityContract.Companion.Entrada.COLUMNA_URI} NVARCHAR(500) NOT NULL"
            ...
            sqLiteDatabase.execSQL("CREATE TABLE ${ComunityContract.Companion.Backup.NOMBRE_TABLA} "
                    ...
                    + " , ${ComunityContract.Companion.Backup.COLUMNA_URI} NVARCHAR(500) NOT NULL"
        ...
        try {
            ...
            for (c in lista) {
                val initializer = "INSERT INTO $tablename ( " +
                        ...
                        "${ComunityContract.Companion.Entrada.COLUMNA_NAME} ) VALUES ( ${c.flag} ,'${c.uri}' , '${c.name}' );"
